...
if uploaded_file is not None:
    try:
        ...
        k = st.number_input("2. Select the number of clusters (territories):", min_value=2, max_value=min(50, len(df_cleaned)), value=5, step=1) # Max clusters cannot exceed number of data points
        ...
        if st.button(f"3. Generate {k} Clusters", type="primary"):
            with st.spinner('Performing clustering... Please wait.'):
                ...
                col1, col2 = st.columns() # Map takes 2/3 width, Summary 1/3
                ...
                with col1:
                    ...
                    st_folium(m, width=700, height=500, returned_objects=) # returned_objects= prevents sending data back to Python
