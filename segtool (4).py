            ...
            with st.spinner('Performing clustering... Please wait.'):
                ...
                with col1:
                    ...
                    for idx, row in df_cleaned.iterrows():
                        ...
                        # Define popup content (simplified f-string)
                        ...
                        # Create and add the CircleMarker - Ensure parentheses are balanced
                        folium.CircleMarker(
                            location=[row['lat'], row['long']],
                            radius=4,
                            popup=popup_html, # Use the variable
                            tooltip=tooltip_text, # Use the variable
                            color=color,
                            fill=True,
                            fill_color=color,
                            fill_opacity=0.7,
                            weight=1
                        ).add_to(m) # Closing parenthesis for CircleMarker is here, followed by.add_to(m)
